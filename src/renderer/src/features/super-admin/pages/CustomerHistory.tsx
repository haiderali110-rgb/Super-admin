...
const CustomerHistory: React.FC = () => {
  ...
  const [rows, setRows] = useState<HistoryRow[]>([
    ...
    {
      id: '2',
      enterprise: 'Online Mart',
      datetime: '11 Aug, 2023 / 01:05 pm',
      accessCode: '910334',
      phone: '(608) 555-0187',
      duration: '00:11:42',
    },
            ...
            {showHistoryDD && (
              <div className="dropdown-menu history-dd">
                ...
                <div className="menu-item active-blue">
                  {labels.dropdown.customer} <ChevronRight size={14} />
                </div>
