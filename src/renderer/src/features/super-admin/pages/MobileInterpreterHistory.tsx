...
const initialHistoryRows: HistoryRow[] = [
  {
    id: '1',
    enterprise: 'Mobile Connect',
    datetime: '13 Sep, 2023 / 09:05 am',
    accessCode: '660192',
    language: 'Arabic',
    duration: '00:12:40',
  },
  {
    id: '2',
    enterprise: 'On-the-Go Services',
    datetime: '14 Sep, 2023 / 11:30 am',
    accessCode: '993201',
    language: 'Spanish',
    duration: '00:27:10',
  },
            ...
            {showHistoryDD && (
              <div className="dropdown-menu history-dd">
                ...
                <div className="menu-item active-blue">
                  {labels.dropdown.mobileInterpreter} <ChevronRight size={14} />
                </div>
...
export default MobileInterpreterHistory;
